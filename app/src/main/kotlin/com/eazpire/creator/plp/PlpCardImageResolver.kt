...
object PlpCardImageResolver {
    ...
    suspend fun resolve(
    ...
    ): PlpCardDisplay = EazPerfTrace.measureSectionSuspend("mock.resolveCardImages") {
        withContext(Dispatchers.IO) {
            ...
            val sessionOn = sessionTryOnActive ||
                CustomerMockPreviewStore.isTryOnSessionActive(context, product.handle)
            ...
            EazPerfTrace.incrementCounter("mock_card_resolve")
